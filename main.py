...
if do==1:
    ...
    difference(miic_learned_bn, greedy_learned_bn, "differences/diff_greedy_miic")
    difference(gt_bn, miic_learned_bn, "differences/diff_miic_gt")
    difference(gt_bn, greedy_learned_bn, "differences/diff_greedy_gt")
